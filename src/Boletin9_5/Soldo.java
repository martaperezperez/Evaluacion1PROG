    ...
    public void soldoDosTrabajadores(){
        ...
        while (i<numTrabajadores){
            ...
            if (soldo>=1000 && soldo<=1750){
                ...
                contador2++;
                porcentaje=(100/numTrabajadores)*contador2;
            }
            i++;
        }
        float contador3=((contador2+100)/numTrabajadores);
        System.out.println("Hay " + contador1 + " trabajadores que cobran entre 1000 y 1750 y hay " + contador2 + "Que no llegan a cobrar 1000€" );
    }
}
